	...
	public function executeSettings(): string {
		...
		if ($this->wire('input')->post('_ichiban_settings')) {
			...
			$safeKeys = ['entity_type','entity_name','entity_url','verify_bing',
			             ...
			             'gsc_client_id','gsc_client_secret','indexnow_key','twitter_site','title_format','title_max_length',
			             'meta_description_fallback','meta_description_min_length','meta_description_max_length',
			             'global_defaults','template_title_formats',
