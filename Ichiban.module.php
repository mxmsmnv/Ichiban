...
class Ichiban extends WireData implements Module, ConfigurableModule {
	 ...
	 *
	 * Resolved from the actual admin page (matched by its process) so that links
	 * keep working when the page is renamed or moved. Falls back to the default
	 * install location (admin/ichiban/) if the page cannot be found.
	 *
	 * @param bool $http Return the absolute httpUrl (required for OAuth redirect URIs).
	 * @param string $path Optional sub-path appended to the page URL, e.g. 'audit/'.
	 */
